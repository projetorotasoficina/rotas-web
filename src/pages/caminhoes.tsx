...
export function CaminhoesPage() {
  ...
  const [editingCaminhao, setEditingCaminhao] = useState<Caminhao | null>(
    null
  )
  ...
  const { data: caminhoes = [], isLoading } = useListCaminhoes()
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{deletingCaminhao?.modelo}</strong>? Esta ação não pode ser
              desfeita.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
