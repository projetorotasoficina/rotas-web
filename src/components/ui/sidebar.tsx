...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    // biome-ignore lint/nursery/noShadow: shacnui default
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: shacnui default
      document.cookie = `${SIDEBAR_COOKIE_NAME}=${openState}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}`
    },
    [setOpenProp, open]
  )

  // biome-ignore lint/correctness/useExhaustiveDependencies: shacnui default
